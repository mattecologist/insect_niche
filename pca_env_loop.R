...
mmc <- reclassify (mmm, c (-Inf, -20, NA))
...
write.csv (outdata, file=paste0("~/Documents/niche/pca_nobuffMESS20/pca_env",pcat,".csv"))
write.csv (ident, file=paste0("~/Documents/niche/pca_nobuffMESS20/pca_env_ident",pcat,".csv"))
